...
function Index() {
    return (
        <div className="flex flex-col  justify-between items-center py-4 my-auto h-fit mx-auto md:mt-10 px-5 md:px-20 ">
            <div className="w-full bg-slate-100 mb-10">
            ...
            <div className="lg:flex bg-slate-100">
                <div className="xl:w-2/5 lg:w-2/5 bg-orange-500 m-5 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
                    <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                        ...
                        <p className="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">
                            Got a question about us? Have some suggestions or
                            just want to say Hi? Just contact us. We are here to
                            asset you.
                        </p>
                        ...
                        <div className="flex items-center">
                            ...
                            <p className="pl-4 text-white text-base">
                                adiprabhastore@gmail.com
                            </p>
                        </div>
                        <p className="text-lg text-white pt-10 tracking-wide">
                            H.N. 75, Street 12, SAMTA VIHAR <br />
                            MUKANDARPUR, LIBASPUR <br />
                            DELHI - 110042
                        </p>
                    </div>
                </div>
                <div className="xl:w-3/5 lg:w-3/5 bg-slate-100 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
                    <form
                        id="contact"

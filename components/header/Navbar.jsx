...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      } ${pathname === "/Admin" && "hidden"} w-full top-0 start-0 p-2  z-50`}
    >
        ...
        <li className="relative hover:bg-gray-100 py-1">
          <Link
            ...
            className={`block px-3 ${
              pathname === "/" ? "text-green-500" : "text-gray-900"
            }`}
            aria-current="page"
          >
            Home
                  ...
                  <div key={index} className="grid grid-cols-1 ">
                    ...
                    >
                      <button
                        ...
                        onClick={() => router.push(`/${menu}/${item}`)}
                      >
                        {item}
                        {nav2[menu][item].length > 0 && <span>›</span>}
                      </button>
                      ...
                      {nav2[menu][selectedCategory] &&
                        selectedCategory === item && (
                          <div className="absolute left-full top-0 w-64 bg-white">
                            <ul>
                              {nav2[menu][selectedCategory].map(
